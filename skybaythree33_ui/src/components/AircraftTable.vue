    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'passengerCapacity',
          visible: true,
          scopedSlots: { customRender: 'passengerCapacity' },
          sorter: true
          //sorter: (a, b) => a.passengerCapacity - b.passengerCapacity,
          //sorter: (a, b) => a.passengerCapacity.localeCompare(b.passengerCapacity),
        },
      ],
      pagination: {
        current: 1,
