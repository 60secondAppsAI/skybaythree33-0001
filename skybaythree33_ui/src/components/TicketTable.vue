    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'ticketPrice',
          ...
          //sorter: (a, b) => a.ticketPrice.localeCompare(b.ticketPrice),
        },
        {
          title: 'Ticket Class',
		dataIndex: 'ticketClass',
          visible: true,
          scopedSlots: { customRender: 'ticketClass' },
          sorter: true
          //sorter: (a, b) => a.ticketClass - b.ticketClass,
          //sorter: (a, b) => a.ticketClass.localeCompare(b.ticketClass),
        },
      ],
      pagination: {
        current: 1,
