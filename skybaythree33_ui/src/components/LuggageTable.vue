...
<template>
  ...
  <base-input label="LuggageType" type="text" placeholder="Enter LuggageType" v-model="luggageToAdd.luggageType"></base-input>
                  </form>
                </div>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          title: 'Luggage Type',
		dataIndex: 'luggageType',
          visible: true,
          scopedSlots: { customRender: 'luggageType' },
          sorter: true
          //sorter: (a, b) => a.luggageType - b.luggageType,
          //sorter: (a, b) => a.luggageType.localeCompare(b.luggageType),
        },
      ],
      pagination: {
        current: 1,
